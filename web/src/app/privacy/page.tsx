...
export const metadata: Metadata = {
  title: "Privacy Policy | Agent",
  description: "How Agent handles your data and protects your privacy.",
};
        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-muted-foreground">
              Agent is built on a simple principle:{" "}
          ...
          <section>
            ...
            <p className="mb-4 text-muted-foreground">
              Agent runs on Google Cloud Platform&apos;s Vertex AI infrastructure. Your data is
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Agent uses models available through Vertex AI and its partner ecosystem. The
          ...
          <section className="rounded-lg border border-border/50 bg-muted/30 p-6">
            <h2 className="mb-3 text-xl font-semibold">Agent Secure</h2>
            <p className="mb-4 text-muted-foreground">
              For organisations with the strictest data sovereignty requirements, Agent Secure
            ...
            <p className="text-muted-foreground">
              With Agent Secure, your data never leaves your environment — not even for LLM
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              When you connect Agent to external services (Google Drive, BigQuery, web search),
