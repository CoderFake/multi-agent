...
async def get_all_memories(
    ...
    memories = await memory_service.get_all_memories(user_id=user.id, db=db)
...
async def delete_memory(
    ...
    success = await memory_service.delete_memory(memory_id, db=db)
    if not success:
...
async def delete_all_memories(
    ...
    success = await memory_service.delete_all_memories(user_id=user.id, db=db)
    if not success:
